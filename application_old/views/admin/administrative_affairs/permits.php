                        ...
                        <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                            <div class="col-xs-12">
                             ...
                             <div class="col-xs-12">
                                ...
                                <div class="col-xs-6 r-input">
                                    <input type="text" class="r-inner-h4" name="emp_code" value="<?if(!empty($select[$_SESSION['emp_code']][0]->employee)): echo  $select[$_SESSION['emp_code']][0]->employee ; endif;?>"  readonly="" />
                                </div>
                            </div>
                            <div class="col-xs-12">
                                <div class="col-xs-6">
