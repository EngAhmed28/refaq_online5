        ...
        foreach ($eval_setting as $rows ):?>
            ...
            <tr>
                ...
                <td>   <input type="number" class="r-inner-h4" id="grade<?php echo $a ?>" min="0" max="<?php echo $rows->grade;?>"
                               name="evaluation_type_grade<?php echo $a ?>" value="<?php echo $emp_grade?>" onkeyup="CalculateTotal('<?php echo $a ?>');" /> </td>
            </tr>
            <?php
            $a++;  $total+=$rows->grade  ;
        endforeach;  ?>
...
<script>
    function CalculateTotal(num) {
        var max_grade=$("#max"+num).val();
        var emp_grade=$("#grade"+num).val();
