...
<body id="page-top" data-spy="scroll" data-target="" class="flexcroll">
	...
	<div class="bottom-button">
		<a id="to-top" class="btn btn-lg btn-inverse page-scroll" href="#page-top"> 
         <span class="sr-only">Toggle to Top Navigation</span> <i class="fa fa-chevron-up"></i> </a>
	</div>
	...
	<div class="top-nav">
            ...
            <?php else :?>
					<li class="dropdown account">
						...
						<ul class="dropdown-menu text-center" style="display: none;">
							...
							<li><p class="register">هل أنت مستخدم جديد ؟ <a href="<?php echo base_url()."web/read_instructions"?>">التسجيل</a> </p></li>
							<hr>
		...
		<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                 <i class="fa fa-money" aria-hidden="true"></i> ريال سعودى - SAR <span class="caret"></span></a>
	...
	<a href="#" class="dropdown-toggle search" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
