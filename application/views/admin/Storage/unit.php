<div class="col-sm-11 col-xs-12">
    ...
    <?php if(isset($results)):?>
        ...
        <?php echo form_open_multipart('dashboard/update_unit/'.$results['id'],array('class'=>"",'role'=>"form" ))?>
                ...
                <div class="col-xs-12 r-inner-details">
                    <div class="col-xs-12">
                        <div class="col-md-12  col-sm-12 col-xs-12 inner-side r-data">
                            <div class="col-xs-12">
                                <div class="col-sm-3">
                                    <h4 class="r-h4"> اسم الوحدة </h4>
                                </div>
                                <div class="col-sm-9 r-input">
                                    <input type="text" class="r-inner-h4 " value="<?php echo $results['unit_name'] ?>" name="unit_name" required>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <?php else: ?>
        ...
        <?php echo form_open_multipart('dashboard/add_unit',array('class'=>"",'role'=>"form" ))?>
                ...
                <div class="col-xs-12">
                    <div class="col-md-12  col-sm-12 col-xs-12 inner-side r-data">
                        <div class="col-xs-12">
                            ...
                            <div class="col-sm-9 r-input">
                                <input type="text" class="r-inner-h4 " name="unit_name" required>
                            </div>
                        </div>
                    </div>
                </div>
