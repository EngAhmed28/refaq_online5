 ...
 public function final_result(){
   ...
   $this->load->view('web_index', $data);   
    ...
    public function inbox($type, $id){
        ...
        $data['fetch_users'] = $data['all_family']=$this->Register->family(1);//$this->Email_family->fetch_users();
        //echo'<pre>';var_dump($data['fetch_users']);die;
        ...
        $data['subview'] = 'web/email_family/email';
        $this->load->view('web_index', $data);
    }
    ...
    public function inbox_table($status){
        ...
        $data['starred'] = $this->Email_family->select_emails(1,'','to',''); 
        $data['deleted'] = $this->Email_family->select_emails('',1,'to','');
        $data['subview'] = 'web/email_family/inbox';
        $this->load->view('web_index', $data);
    }
    ...
    public function reading($id){
        ...
        $data['starred'] = $this->Email_family->select_emails(1,'','to',''); 
        $data['deleted'] = $this->Email_family->select_emails('',1,'to','');
        $data['subview'] = 'web/email_family/reading';
        $this->load->view('web_index', $data);
    }
