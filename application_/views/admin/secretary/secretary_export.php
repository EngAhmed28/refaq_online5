    ...
    <div class="col-xs-12 r-bottom">
        <div class="panel-heading">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="<?php echo base_url()?>admin/Secretary/secretary_export"> أضافة الصادر </a></li>
                        ...
                        <div class="col-xs-6 ">
                            <form class="r-block">
                                <?php if($results['export_type_id_fk']==0){
                                    ...
                                    echo' <input type="radio" class="r-radio" value="0" name="export_type_id_fk" checked id="r-in"/> داخلي
                                <input type="radio" class="r-radio" value="1" name="export_type_id_fk" id="r-out"/> خارجي
                                                         ';
                                }else{

                                echo' <input type="radio" class="r-radio" value="0" name="export_type_id_fk"  id="r-in"/> داخلي
                                <input type="radio" class="r-radio" value="1" name="export_type_id_fk" checked id="r-out"/> خارجي
';                                            } ?>
            ...
            <div class="col-xs-12">
                <div class="col-md-6  col-sm-12 col-xs-12 inner-side r-data">
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-6 ">
                            <form class="r-block">
                                <input type="radio" class="r-radio" value="0" style="width: 15px" name="export_type_id_fk" checked id="r-in"/> داخلي
                                <input type="radio" class="r-radio" value="1" name="export_type_id_fk" id="r-out"/> خارجي
                            </form>
                        </div>
                    </div>
...
<tr>
    ...
    <td><a href="<?php echo base_url('admin/Secretary/delete_export').'/'.$record->id ?>"> <i class="fa fa-trash" aria-hidden="true"></i> </a> <span>/
    </span> <a href="<?php echo base_url('admin/Secretary/update_secretary_export').'/'.$record->id ?>"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a> </td>
    <td >
                ...
                <div class="col-sm-9">
                    ...
                    <div class="col-xs-12 inner-side r-data">
                        ...
                        <div class="col-xs-12 r-pop-table">
                            ...
                            <div class="col-xs-9 r-table-padding r-input">
                                <h4 class="r-inner-h4"><?php echo strip_tags($record->content) ?></h4>
                            </div>
                        </div>
