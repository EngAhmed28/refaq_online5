                                    ...
                                    <div class="modal fade" id="myModal-<?php echo $row->permit_num; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content" >
                                               ...
                                               <div class="col-md-6">
                                                <label for="inputUser" class=" control-label">سبب القبول او الرفض</label>
                                               
                                             </div>
                                                 <div class="col-md-6">
                                                  <input  id="reason"  name="reason"  class="r-inner-h4" placeholder="سبب القبول او الرفض" required/>
                                                 </div>
                                                <table  class="table table-bordered">
                                                    <tr>
                                                        <input type="hidden" name="id" value="<? echo $date->id;?>" >
                                                        <th width="40%" class="text-right"> <input style="margin-left: 70px;" type="submit"  name="accept" value="موافقة"  class="btn btn-success btn-xs" ></th>
                                                        <th width="40%" class="text-right"> <input  style="margin-left: 70px;" type="submit"  name="refuse" value="رفض"  class="btn btn-danger btn-xs" ></th>
                                                    </tr>
                                                </table>
